...
mysql_query("update Utente set Nome='$nome_update',Cognome='$cognome_update',Mail='$mail_update',Password='$password_update' where id=".$_SESSION['id']);
session_start();
       $nome=$_SESSION['Nome'];
...
<?php
include "db.php";
    $query=mysql_query("select * from Utente where id=$idUtente");
