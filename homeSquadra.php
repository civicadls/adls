...
$nome=$_SESSION['Nome'];
 ...
 header("Location:VisualizzaSegnalazioneSquadra.php");
 }
...
$nome=$_SESSION['Nome'];
 ...
 $nome=$_SESSION['Nome'];
    ...
    $idUtente=$_SESSION['id_squadra'];
 header("Location:accountSquadra.php");
 }
...
$nome=$_SESSION['Nome'];
    ...
    $query=mysql_query("select Nome_Comune,Logo from Squadra inner join Comuni where Squadra.Comune=id_comune and id_squadra=".$idUtente);
            ...
            <div class="container-fluid">
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <form method="POST" action="homeSquadra.php">
                ...
                <div class="col-lg-6">
                  <div class="feature-item">
                    ...
                    <h3>Gestisci Squadre</h3>
                    <p class="text-muted">Accedi a questa sezione per gestire le squadre di risoluzione!</p>
                  <br>
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  ...
                  <input type="submit" name="Profilo" value="Impostazioni" class="btn btn-ente">
                  </form>  
                  </div>
                </div>
              </div>
