...
<section class="features" id="features">
 ...
 <div class="row">
<form method='post' action="VisualizzaSegnalazioneEnte.php">
...
$query=mysql_query("select * from Segnalazioni inner join Stato_segnalazione where Segnalazioni.Tracking= Stato_segnalazione.Tracking and Comune=".$_SESSION['id_comune']);
                      ...
                      if($_POST['Importanza']=='Tutte' && $_POST['Stato']!='Tutte')
                      {
                       $query=mysql_query("select * from Segnalazioni inner join Stato_segnalazione where Segnalazioni.Tracking= Stato_segnalazione.Tracking and Stato='$Stato' and Comune=".$_SESSION['id_comune']);
                      }
                      else if($_POST['Importanza']!='Tutte' && $_POST['Stato']=='Tutte'){
                      $query=mysql_query("select * from Segnalazioni inner join Stato_segnalazione where Segnalazioni.Tracking= Stato_segnalazione.Tracking and Importanza='$Importanza' and Comune=".$_SESSION['id_comune']);
                      }else if($_POST['Importanza']!='Tutte' && $_POST['Stato']!='Tutte'){
                      $query=mysql_query("select * from Segnalazioni inner join Stato_segnalazione where Segnalazioni.Tracking= Stato_segnalazione.Tracking and Stato='$Stato'and Importanza='$Importanza' and Comune=".$_SESSION['id_comune'] );
                      }
                      }
