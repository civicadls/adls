...
{ 
mysql_query("UPDATE Stato_segnalazione SET Stato='Conclusa' WHERE Tracking='$codice_di_tracking'");
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <form name="FormApprovazione" method="post" action="VisualizzaInformazioniSquadra.php?Tracking=<?php echo $codice_di_tracking?>">
 
     <br>
          <input class="btn btn-primary" type="submit" value="Concludi" name="Concludi">
         <!-- </form>-->
