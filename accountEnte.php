...
mysql_query("update Ente set Nome='$nome_update',Cognome='$cognome_update',Mail='$mail_update',Password='$password_update' where id_Ente=".$_SESSION['Id_Ente']);
session_start();
       $nome=$_SESSION['Nome'];
...
?>
      ...
      <div class="container">
       ...
       <div align="center" class="form-group row">
        ...
        <div class="col-4">
        	<label for="example-text-input" class="form-control"><?php echo $Nome_Comune?></label>
            </div>
            </div>
        <div align="center" class="form-group row">    
